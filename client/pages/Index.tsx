        ...
        <div className="container mx-auto px-6 py-6">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-12">
              <Link
                to="/"
                className="text-white font-['Plus_Jakarta_Sans'] font-semibold text-lg tracking-wide hover:text-purple-400 hover:scale-110 hover:underline underline-offset-4 transition-all duration-300"
              >
                Home
              </Link>
            ...
            <div className="md:hidden bg-black/90 backdrop-blur-md">
              <div className="flex flex-col space-y-4 p-6">
                ...
                <button
                  ...
                  className="text-white font-['Plus_Jakarta_Sans'] font-semibold text-lg tracking-wide hover:text-purple-400 transition-colors text-left"
                >
                  About
                </button>
                <button
